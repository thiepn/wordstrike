...
for (const asset of [
  "./js/flow/flowRuntimeLoader.js?v=20260923f",
...
const mainIndex = index.indexOf('src="js/main.js?v=20260923e"');
const releaseIndex = index.indexOf('src="js/flow/flowRuntimeLoader.js?v=20260923f"');

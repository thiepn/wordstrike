...
test("PL29 keeps generic persistence and foundation versions unchanged", () => {
  assert.equal(PRACTICE_DATABASE_VERSION, 8); assert.equal(PRACTICE_RECORD_VERSIONS.sessionSummary, 13); assert.equal(PRACTICE_FOUNDATION_ANALYSIS_VERSION, 10);

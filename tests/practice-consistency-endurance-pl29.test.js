...
test("PL29 generic record and foundation versions remain stable inside the current PL38 DB12/session14 envelope", () => {
  assert.equal(PRACTICE_DATABASE_VERSION, 12); assert.equal(PRACTICE_RECORD_VERSIONS.sessionSummary, 14); assert.equal(PRACTICE_FOUNDATION_ANALYSIS_VERSION, 10);

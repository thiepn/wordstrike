...
test("PL10 generic normalization remains canonical inside the current PL14 session envelope", async () => {
...
test("PL10 experiment analyzers receive frozen PL14 foundationAnalysis v6 and cannot own normalization or canonical skill evidence", async () => {
  let received = null;

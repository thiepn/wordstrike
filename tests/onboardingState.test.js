...
assert.equal(ONBOARDING_TUTORIALS.practice.steps.length, 4);
assert.match(ONBOARDING_TUTORIALS.practice.steps[0].body, /Full Assessment is optional/);
assert.match(ONBOARDING_TUTORIALS.practice.steps[2].body, /not a universal typing score/);

...
try {
  ...
  assert.match(loader, /wordstrike-flow-release-v28/);
  ...
  console.log("Flow V4 identity integrity contracts passed: canonical theme allowlist, stale-preference fallback, source identity, and offline wiring.");
} finally {

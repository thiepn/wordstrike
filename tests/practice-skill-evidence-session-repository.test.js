...
test("PL11 canonical deltas remain intact inside the current PL38 foundation v10/session v14 envelope, and experiment full-stat output cannot replace evidence", async () => {
  let foundation = null;

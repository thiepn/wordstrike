...
const rows = [
  {
    id: "a1", userId: "a", username: "Alpha", boardKey: "flow-standard-3m-v1",
    rulesVersion: 4, moderationStatus: "accepted", completed: true,
    score: 90000, accuracy: 97, wpm: 100, rawWpm: 103, consistency: 88,
    wordsCompleted: 800, durationMs: 180000, submittedAt: "2026-09-23T10:00:00Z",
  },
  {
    id: "a2", userId: "a", username: "Alpha", boardKey: "flow-standard-3m-v1",
    rulesVersion: 4, moderationStatus: "accepted", completed: true,
    score: 91000, accuracy: 96, wpm: 105, rawWpm: 108, consistency: 90,
    wordsCompleted: 850, durationMs: 179950, submittedAt: "2026-09-23T11:00:00Z",
  },
  {
    id: "b1", userId: "b", username: "Beta", boardKey: "flow-standard-3m-v1",
    rulesVersion: 4, moderationStatus: "accepted", completed: true,
    score: 91000, accuracy: 98, wpm: 99, rawWpm: 101, consistency: 92,
    wordsCompleted: 820, durationMs: 180050, submittedAt: "2026-09-23T12:00:00Z",
  },
  {
    id: "c1", userId: "c", username: "Gamma", boardKey: "flow-standard-3m-v1",
    rulesVersion: 4, moderationStatus: "accepted", completed: true,
    score: 91000, accuracy: 98, wpm: 101, rawWpm: 104, consistency: 87,
    wordsCompleted: 830, durationMs: 180000, submittedAt: "2026-09-23T13:00:00Z",
  },
  {
    id: "old-rules", userId: "d", username: "Old", boardKey: "flow-standard-3m-v1",
...
const ranked = rankLeaderboardRows(rows, { boardKey: "flow-standard-3m-v1", viewerUserId: "a" });
...
console.log("Flow global leaderboard contracts passed: one timed 3-minute rules-v4 board, score validation, best-per-player ranking, volume display, and server-only RPC access.");

        ...
        with sync_playwright() as playwright:
            ...
            for width, height, touch in [(1280, 800, False), (390, 844, True)]:
                ...
                overflow = page.evaluate("""() => ({
                  ...
                  v3: document.querySelector('[data-speed-performance-v3]').scrollWidth
                    - document.querySelector('[data-speed-performance-v3]').clientWidth,
                ...
                page.screenshot(
                    path=str(ARTIFACTS / f'typing-performance-v3-{width}x{height}.png'),
                    full_page=True,
                )

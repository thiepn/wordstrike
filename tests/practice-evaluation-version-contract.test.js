...
test("PL18 historical session v10 evaluation migration remains null through the current PL38 v14 wrapper", () => {
  ...
  assert.deepEqual(migrated.steps.slice(-4), ["sessionSummary:10->11", "sessionSummary:11->12", "sessionSummary:12->13", "sessionSummary:13->14"]);
});

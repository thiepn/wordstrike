...
const REVIEWED_INNER_HTML = Object.freeze({
  ...
  "js/practiceLab/practiceLabRendererCurrent.js": [17, "consolidated reviewed renderer; inherited dynamic values retain the same escaped, validated, bounded, or safe-DOM-property handling certified before Phase 8"],

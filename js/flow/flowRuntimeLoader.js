...
const FLOW_RELEASE_VERSION = 3;
const FLOW_RELEASE_CACHE_NAME = "wordstrike-flow-release-v4";
...
async function importFlowRuntime() {
  ...
  try {
    ...
    await Promise.all([
      import("./flowPhase1.js?v=20260923c"),
    ...
    if (release) {
      await import("./flowGameModeV2.js?v=20260923b");
    }

...
const FLOW_RELEASE_VERSION = 25;
const FLOW_RELEASE_CACHE_NAME = "wordstrike-flow-release-v28";
...
const FLOW_RELEASE_ASSETS = Object.freeze([
  "./js/flow/flowRuntimeLoader.js?v=20260925c",
  ...
  "./js/flow/flowPhase1.js?v=20260925c",
  ...
  "./js/flow/flowUxPhase8.js?v=20260925c",
  ...
  "./styles/screens/flow-game-mode-v2.css?v=20260925c",
...
async function importFlowRuntime() {
  ...
  try {
    ...
    await Promise.all([
      import("./flowPhase1.js?v=20260925c"),
    ...
    if (params.get("flowUi") === "1") {
      ...
      if (params.get("flowUx") === "1") {
        await import("./flowUxPhase8.js?v=20260925c");
        await Promise.resolve();
        const extensions = [];

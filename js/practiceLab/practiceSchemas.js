...
export const PRACTICE_RECORD_TYPES = Object.freeze({
  ...
  assessmentRun: Object.freeze({ storeName: "assessmentRuns", versionField: "recordVersion" }),
  coachPlan: Object.freeze({ storeName: "coachPlans", versionField: "recordVersion" }),

...
export function createPracticeLabController(options={}) {
  ...
  function renderer(renderRoot,view,renderOptions={}) {
    ...
    if(protocolId){attach();return renderPracticePreviewProtocolSetup(renderRoot,protocolId);}

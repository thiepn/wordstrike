...
export function renderPracticeAccuracyRecoveryDetail(root, view, { focusSelector = null } = {}) {
  root.innerHTML = `<section class="screen practice-lab-screen" data-practice-view="accuracy-recovery-detail"><div class="practice-lab-shell"><header class="practice-lab-header"><button type="button" class="practice-lab-back" data-practice-action="back">← Back to Practice Lab</button><span class="practice-lab-status is-preview">DEVELOPER PREVIEW</span></header><main class="practice-lab-detail"><div class="eyebrow">Precision · control intervention</div><h1>Accuracy & Recovery</h1><p class="practice-lab-lead">Practice clean first-pass typing and more precise recovery when errors occur, without chasing an artificially slow perfect score.</p>

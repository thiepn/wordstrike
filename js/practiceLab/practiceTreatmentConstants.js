...
export const PRACTICE_TREATMENT_OUTCOME_KEYS = Object.freeze({ SAME_PROTOCOL_RETEST: "same-protocol-retest", RETENTION_REVIEW: "retention-review", COLD_TRANSFER: "cold-transfer", ABILITY: "ability", CONSISTENCY: "consistency", CONTROL_FRONTIER: "control-frontier" });
export const PRACTICE_TREATMENT_OUTCOME_DOMAINS = Object.freeze(["entity-target", "cold-natural-text", "common-words", "control-frontier", "burst", "consistency", "read-ahead", "endurance", "punctuation", "numbers-symbols"]);

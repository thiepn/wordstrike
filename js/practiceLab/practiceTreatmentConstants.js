...
export const PRACTICE_TREATMENT_OUTCOME_SOURCE_KINDS = Object.freeze([
  "target-baseline-retest", "retention-review", "cold-transfer", "ability-observation", "consistency-result", "control-frontier",
]);
export const PRACTICE_TREATMENT_OUTCOME_KEYS = Object.freeze({ SAME_PROTOCOL_RETEST: "same-protocol-retest", RETENTION_REVIEW: "retention-review", COLD_TRANSFER: "cold-transfer", ABILITY: "ability", CONSISTENCY: "consistency", CONTROL_FRONTIER: "control-frontier", METRONOME_SILENT: "metronome-silent" });
export const PRACTICE_TREATMENT_OUTCOME_DOMAINS = Object.freeze(["entity-target", "cold-natural-text", "common-words", "control-frontier", "burst", "consistency", "read-ahead", "metronome-cadence", "endurance", "punctuation", "numbers-symbols"]);
export const PRACTICE_TREATMENT_POLICY = Object.freeze({ preparedTtlMs: 24*60*60*1000, minimumDelayedMs: 12*60*60*1000, hybridMinimumDelayedMs: 24*60*60*1000, metronomeMinimumDelayedMs: 24*60*60*1000, metronomeMaximumMs: 30*24*60*60*1000, retestMaximumMs: 14*24*60*60*1000, abilityMaximumMs: 30*24*60*60*1000, retentionMaximumMs: 60*24*60*60*1000, transferMaximumMs: 30*24*60*60*1000, consistencyBaselineMaximumAgeMs: 30*24*60*60*1000, consistencyMaximumMs: 30*24*60*60*1000, frontierMaximumMs: 30*24*60*60*1000, baselineQualityCoverageMinimum: 0.60, relatedTargetIdMaximum: 8, responseSamplesMaximum: 64, episodeOutcomeMaximum: 4 });
export const PRACTICE_TREATMENT_THRESHOLDS = Object.freeze({ targetQualityPoints: 5, abilityPercent: 2, frontierPercent: 3, consistencyVariationPp: 1.5, abilityZ: 0.75 });
export const PRACTICE_TREATMENT_DELAY_BOUNDARIES = Object.freeze({ nextDayMaximumMs: 3*24*60*60*1000, shortMaximumMs: 14*24*60*60*1000 });
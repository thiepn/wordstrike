...
export async function mountPracticePreviewProtocolSession({root,experimentId,durationMs,onExit=()=>{}}){
  ...
  try {
    ...
    const passage=node('p');passage.dataset.protocolText='';passage.className='practice-real-text-typing';passage.style.cssText='white-space:pre-wrap;overflow-wrap:anywhere;font:1.2rem/1.8 monospace;max-height:40vh;overflow:hidden';

...
const nodeRuntime = IS_NODE_RUNTIME ? await import("./practiceLabControllerRuntimeV31.js") : null;
...
export function createPracticeLabController(options = {}) {
  ...
  const loadRuntime = () => {
    ...
    runtimePromise = Promise.all([
      import("./practiceExperimentRegistryRuntime.js"), import("./practiceLabControllerRuntimeV31.js"),

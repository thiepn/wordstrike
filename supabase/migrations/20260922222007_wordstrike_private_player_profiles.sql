...
comment on table public.wordstrike_player_profiles is
  'WordStrike account-scoped CRDT snapshots. Client writes use revision compare-and-swap; no auth tokens or public ranking authority.';
